...
<?php  echo $html->css('admin_style'); ?>
<?php  echo $html->css('admin_happy'); 
		echo $this->Html->css('pepper-grinder/jquery-ui');

echo $html->script('jquery.min');
		echo $this->Html->script('jquery-ui.min'); ?>
<?php  echo $html->script('plupload/js/plupload.full.js'); ?>
...
<div class="input file">
	<div id="file-<?php echo $name.'-'.$lang ?>">
		<div id="pickfiles-container">
		    ...
		    <div class="a pickfiles" id="pickfiles" href="javascript:;"><?php echo $html->image('/img/boxupload32.png'); ?>
				<a id="file-<?php echo $name.'-'.$lang ?>-pickfiles" >A partir de mon ordinateur</a>
		    </div> 
		    <div  class="a distantfiled"><?php echo $html->image('/img/Slideshow.png'); ?>
...
var uploader = new plupload.Uploader({
	...
	max_file_size : '6mb',
	url : '<?php echo $html->url('/admin/',true); ?>'+'/contents/upload?extension=<?php echo $extension ?>'+
	...
	flash_swf_url : '<?php echo $html->url('/js/plupload/js/plupload.flash.swf',true); ?>',
	silverlight_xap_url : '<?php echo $html->url('/js/plupload/js/plupload.silverlight.xap',true); ?>',
	filters : [
...
function displayImage(filename)
{
	...
	$('.image').html(
		    '<img src="<?php echo $html->url('/files/uploads/'.$extension); ?>'+
                    '/'+filename+'_0x100"/>');
    $('.actions').show();
    //alert(filename);
...
function CExplorer()
{
    ...
    this.base = '<?php echo $html->url('/',true); ?>',//'http://www.pcm-ensemblier.com/';
...
var uploader = new plupload.Uploader({
	...
	container: 'container',
	max_file_size : '10mb',
	url : '<?php echo $html->url('/js/pluplad/examples/',true); ?>upload.php',
	resize : {width : 320, height : 240, quality : 90},
	flash_swf_url : '<?php echo $html->url('/js/pluplad',true); ?>/js/plupload.flash.swf',
	silverlight_xap_url : '<?php echo $html->url('/js/pluplad',true); ?>/js/plupload.silverlight.xap',
	filters : [
		{title : "Image files", extensions : "jpg,gif,png"},
		{title : "Zip files", extensions : "zip"}
	]
