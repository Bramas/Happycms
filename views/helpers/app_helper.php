...
class AppHelper extends Helper
{
    ...
    var $langField = null;
    	...
    	function _initInputField($field, $options = array()) {
            ...
            if($this->langField===null && !empty($view->langField))
            {
                $this->langField=$view->langField;
            }
		...
		if ($field !== null) {
                    ...
                    {
                        $this->setEntity($view->model.'.'.$this->langField.'.'.$field);
                        if(empty($options['id']))
                        {
                            $options['id']=$view->model . join('', array_map(array('Inflector', 'camelize'), array($this->langField,$field)));
                        }
                    }
