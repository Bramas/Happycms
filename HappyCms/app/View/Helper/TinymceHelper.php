 ...
 */
	...
	protected $_defaultsContext = array('extension'=>'all','id'=>'0');
/**
 ...
 * @access public
 */
	public function editor($options = array(),$context = array()) {
		...
		$context = array_merge($this->_defaultsContext, $context);
		...
		echo $this->Html->scriptBlock('/*  */
				function	addEditors(){
						  ...
						  height:\'300px\',
						  language : \'fr\' ,
						plugins : "hp_image,hp_file,videos,media,files,images,safari,pagebreak,style,layer,table,advimage,advlink,inlinepopups,searchreplace,contextmenu,paste,directionality,fullscreen",
						relative_urls : false,
						oninit:function()
						{
...
theme_advanced_buttons1 : "newdocument,|,bold,italic,underline,strikethrough,|,forecolor,|,justifyleft,justifycenter,justifyright,justifyfull,formatselect,fontsizeselect,|,code,|,fullscreen",
...
'theme_advanced_buttons4 : "hp_image,hp_file,videos",'.
'file_browser_callback : "myFileBrowser",
body_id:"tinyMce",
body_class :"Content",
content_css : "'.$this->Html->url('/css/content.css',true).'",
image_explorer : "'.$this->Html->url(array(
'plugin'=>'media',
'controller'=>'manager',
'action'=>'index'
)).'/'.$context['extension'].'/'.$context['id'].'/tinyMce",
image_edit : "/pcm-ensemblier.com/cakephp/media/manager/tiny_show"
