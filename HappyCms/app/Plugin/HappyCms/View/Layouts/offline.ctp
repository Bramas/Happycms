...
<head>
	...
	<?php
		...
		echo $this->Html->css('/HappyCms/css/login');
...
?></div>
            <div id="link-to-admin"><?php echo $this->Html->link(__('Connexion Administrateur',true),array('controller'=>'users','action'=>'login',1)); ?></div>
